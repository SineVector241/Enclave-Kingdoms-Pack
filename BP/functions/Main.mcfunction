...
tp @a[x=84,y=64,z=104,rm=5000, tag=!admin] 84 64 104
title @a[x=84,y=64,z=104,rm=4800] actionbar §4You are near the world border!
...
effect @a[x=84,y=64,z=104,r=50] resistance 1 255 true
effect @a[x=84,y=64,z=104,r=50] fire_resistance 1 255 true
effect @a[x=84,y=64,z=104,r=50] regeneration 1 255 true
gamemode s @a[x=84,y=64,z=104,rm=51,m=!s,tag=!admin]
title @a[x=84,y=64,z=104,rm=51,r=54] subtitle §z§aYou are no longer in spawn!
